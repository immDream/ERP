...
<script>
    ...
    import {ADD_SPECIFICATION_INFO} from "@/store/mutation-types";
    ...
    export default {
        ...
        watch: {
            ...
            "visible": function (newVal, oldVal) {
                if(newVal) {
                    this.ruleForm.categories = this.$props.data.categoriesIdList;
                    // 将数据转为级联菜单可用的数据
                    ...
                    this.categoriesOptions = convertListData(this.$props.data.categoriesData);
                }
            }
        },
        methods: {
            ...
            onOkBtnClick: function () {
                this.$refs.ruleForm.validate((valid) => {
                    if(valid) {
                        this.$store.dispatch(ADD_SPECIFICATION_INFO, {
            ...
            handleTagInputConfirm: function () {
                ...
                if (inputValue) {
                    ...
                    } else this.ruleForm.values.push(inputValue);
                }
